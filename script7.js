...
console.log(namaLengkap.slice(12,5)); // hasilnya kosong

// 6. replace
namaLengkap = namaLengkap.replace('rifki','RIFKI');
console.log(namaLengkap);
...
// 9. exract data number
let dataSring2 = "10,5";
console.log(typeof dataSring2);
let dataInteger = parseInt(dataSring2);
